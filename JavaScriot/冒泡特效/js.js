        ...
        var r = n(5),
            ...
            u = function(t, e, n) {
                var c, f, l, h = t & u.F,
                    ...
                    b = p ? r : d ? r[e] : (r[e] || {})[a];
                p && (n = e);
                for (c in n) f = !h && b && void 0 !== b[c],
                    f && c in g || (l = f ? b[c] : n[c], g[c] = p && "function" != typeof b[c] ? n[c] : y && f ? o(l, r) : m && b[c] == l ?
                        function(t) {
        ...
        var r = n(5),
            ...
            Y = function(t, e, n) {
                return t === q && Y(R, e, n),
                    ...
                    e = _(e, !0),
                    w(n),
                    i(B, e) ? (n.enumerable ? (i(t, N) && t[N][e] && (t[N][e] = !1), n = O(n, {
                        enumerable: x(0, !1)
            ...
            tt = function(t) {
                for (var e, n = t === q,
                        r = A(n ? R : b(t)), o = [], s = 0; r.length > s;) !i(B, e = r[s++]) || n && !i(q, e) || o.push(B[e]);
                return o
            };
        H || (P = function() {
            ...
            C && s(s.S + s.F * (!H || c(function() {
                ...
                stringify: function(t) {
                    if (void 0 !== t && !K(t)) {
                        ...
                        return e = r[1],
                            "function" == typeof e && (n = e), !n && g(e) || (e = function(t, e) {
                                ...
                                l.extend(a.prototype, s.prototype, {
                                    ...
                                    unshift: function(t) {
                                        ...
                                        for (var e = this.length; e--;) this[e] = this[e - 1],
                                            "object" === (0, f.default)(this[e]) && (this[e]._namespace = e + "");
                                        return r(this, 0, t),
                                            this.$change(this.$namespace(), this, null, void 0, 1),
                                            this
                                    },
                                    ...
                                    splice: function(t, e) {
                                        for (var n = {
                                            ...
                                            "object" === (0, f.default)(this[t]) && (this[t]._namespace = t + "");
                        ...
                        function(t, e, n) {
                            ...
                            function s(t) {
                                ...
                                return n.prototype = o(e.prototype),
                                    ...
                                    n.super = e, ["extend", "get", "all", "require", "define"].forEach(function(t) {
                                        n[t] = e[t]
                                    }),
                                    n
                            }
                                        ...
                                        a.forEach(function(a) {
                                            ...
                                            l && h.forEach(function(r) {
                                                ...
                                                h && n.$watch(c,
                                                        ...
                                                        "object" === ("undefined" == typeof d ? "undefined" : (0, f.default)(d)), !i.alpaca && ("boolean" == typeof e.immediate ? e.immediate : void 0 !== d)),
            ...
            function(e, n) {
                ...
                function() {
                    ...
                    function p() {
                        try {
                            var t = n(392);
                            return Y = t.runOnLoop || t.runOnContext,
                                u()
                        } catch (t) {
                            return l()
                        }
                    ...
                    function x(t, e) {
                        e._state === st ? E(t, e._result) : e._state === at ? T(t, e._result) : k(e, void 0,
                            function(e) {
                                return S(t, e)
                            },
                            function(e) {
                    ...
                    function L(t, e) {
                        this._instanceConstructor = t,
                            ...
                            G(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? E(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && E(this.promise, this._result))) : T(this.promise, D())
                    }
                    ...
                    function U(t) {
                        this[it] = F(),
                            ...
                            this._subscribers = [],
                            y !== t && ("function" != typeof t && q(), this instanceof U ? M(this, t) : H())
                    }
                    ...
                    return L.prototype._enumerate = function() {
                        ...
                        L.prototype._settledAt = function(t, e, n) {
                            var r = this.promise;
                            r._state === ot && (this._remaining--, t === at ? T(r, n) : this._result[e] = n),
