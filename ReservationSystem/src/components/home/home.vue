<template>
 <div class="home">
   <div class="home_content">
     ...
     <div class="home_info">
       <h1> 校园参观预约系统</h1>
         <p> 大连东软信息学院热烈欢迎您到校参观。校园参观将带您亲自体验大学生活环境并感受学习文化氛围，参观行程主要包括学生生活区、图书馆、校园风光、学校教学区和大学生创业中心等。
</p>
        <div> 
          <el-button type="danger" @click="P_appointment">预约参观</el-button>
   ...
   <div class="button_bar">
    ...
    <p class="school_info">
                   1、可通过登陆大连东软信息学院官方网站进入预约系统，先选择可参观时间，按照系统提示进行预约。
                   </br>
2、需至少提前1天进行预约，参观当日不能预约。</br>
3、预约成功后将收到我校统一发送的确认邮件，将提示参观时间、地点等信息。当日需凭有效证件参观；如不能按照预约时间参加，可点击邮件“取消预约”选项，进行操作。</br>
